...
class Venue(models.Model):
    ...
    wather=models.CharField(max_length=100,null=True,blank=True)
    credential_collection=models.CharField(max_length=500,null=True,blank=True)
    dressing_room=models.CharField(max_length=500,null=True,blank=True)
    hospitality=models.BooleanField(default=False)
    hospitality_detail=models.TextField(max_length=500,null=True,blank=True)
